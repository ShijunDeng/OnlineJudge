	...
	private void addMyListener() {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Solution su = new Solution(new Matrix(m, n, cof), new Matrix(m,
						1, con));
				su.solve();
				...
				for (int j = 0; j < n; j++) {
					...
					text2.get(j).setText(
							String.valueOf(su.getConstantMatrix().getElementAt(
									j + 1, 1)));
				}
